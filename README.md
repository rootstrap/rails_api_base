...
### Updating docs
Doc are autogenerated based off of the requests specs, no extra code is needed.
...
2. Update doc file
    ...
    2.a. Utilizing parallelization to speed up the process up:
    ```bash
